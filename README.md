# THEME - SEPTEMBER 2022 - VSPHIM CMS
...
## Install
1. Tại thư mục của Project: `composer require vsmov/vsmov-september`
2. Kích hoạt giao diện trong Admin Panel

## Update
1. Tại thư mục của Project: `composer update vsmov/vsmov-september`
...
### Custom View Blade
- File blade gốc trong Package: `/vendor/vsmov/vsmov-september/resources/views/september`
